...
## define a function to Create Stereo-seq object without SCT conversion
...
## Creat the seurat object without SCT conversion for each data on each slide with bin=40
...
## Import the Assigned cell type and scores of bin=40 generated by 01.stereo-seq_cell_type_classification.R into the Seurat object without SCT conversion
...
## merge all stereo-seq seurat objects
...
## Extract the results of the four samples separately
...
## Cut different tissue blocks from different samples
...
## Remove spots with low mapping scores from the TKS5 tissue
