...
## define a function to Create Stereo-seq object with SCT conversion based on https://github.com/yangmean/Spatiotemporal_mouse_implantation_sites/blob/main/02.%20Spaitial_transcriptome_integration.R
